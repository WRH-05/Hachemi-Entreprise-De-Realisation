        ...
        <div className="grid gap-16 max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white">{t.about.founded.title}</h2>
            </div>
            <p className="text-gray-200 leading-relaxed text-base md:text-lg">{t.about.founded.description}</p>
          </motion.section>
